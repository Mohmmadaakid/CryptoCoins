package com.example.mycryptoapplication.adapter
...
import com.example.mycryptoapplication.databinding.CurrencyItemLayoutBinding
import com.example.mycryptoapplication.fragments.HomeFragmentDirections
import com.example.mycryptoapplication.fragments.MarketFragmentDirections
import com.example.mycryptoapplication.fragments.WatchListFragmentDirections
...
class MarketAdapter(var context: Context, var list: List<CryptoCurrency>, var type: String):RecyclerView.Adapter<MarketAdapter.MarketViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MarketViewHolder, position: Int)
    {
        ...
        if (item.quotes!![0].percentChange24h>0){
            holder.binding.currencyChangeTextView.setTextColor(context.resources.getColor(
                R.color.green))
        ...
        holder.itemView.setOnClickListener{
            ...
            if (type=="home")
            {
                ...
                findNavController(it).navigate(
                    WatchListFragmentDirections.actionWatchlistFragmentToDetailFragment2(item))
            }
